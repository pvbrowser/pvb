  ...
  while(1)
  {
    ...
    else // write a default initialisation file
    {
      ...
      if(fp != NULL)
      {
        ...
        fprintf(fp,"-toggle_full_screen = Permuter la grandeur de ffenêtre\n");
        fprintf(fp,"-help               = Aide\n");
        fprintf(fp,"-booklet            = Livret\n");
        fprintf(fp,"-manual             = Manuel\n");
        fprintf(fp,"-about              = à propos\n");
        fprintf(fp,"-recent_urls        = DeDernier sites visite\n");
        ...
        fprintf(fp,"-status_save_as_bmp = enregistrer au BMP\n");
        ...
        fprintf(fp,"-print_header       = Imprimer l'intitulé\n");
        fprintf(fp,"}\n");
        fprintf(fp,"#---------------------------------------\n");
        fprintf(fp,"spanish {\n");
