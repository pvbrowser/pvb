////////////////////////////////////////////////////////////////////////////
//
// show_mask8 for ProcessViewServer created: Sa Nov 11 07:31:35 2006
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvDownloadFile(p,"gnumeric.png");
  pvQImage(p,imageGnuplot1,0,"gnumeric.png",&w,&h,&depth);
  pvSetGeometry(p,imageGnuplot1,10,55,680,620);

  pvQLabel(p,label1,0);
  pvSetGeometry(p,label1,125,10,280,30);
  pvSetText(p,label1,"GnuPlot output");

  pvQPushButton(p,buttonPlot1,0);
  pvSetGeometry(p,buttonPlot1,485,10,100,30);
  pvSetText(p,buttonPlot1,"Plot1");

  pvQPushButton(p,buttonPlot2,0);
  pvSetGeometry(p,buttonPlot2,590,10,100,30);
  pvSetText(p,buttonPlot2,"Plot2");
