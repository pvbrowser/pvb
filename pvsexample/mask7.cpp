////////////////////////////////////////////////////////////////////////////
//
// show_mask7 for ProcessViewServer created: Fr Nov 10 16:33:16 2006
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQVtkTclWidget(p,vtk,0);
  pvSetGeometry(p,vtk,10,55,750,695);

  pvQTextBrowser(p,textBrowser,0);
  pvSetGeometry(p,textBrowser,770,55,450,700);
  pvSetMaxSize(p,textBrowser,450,99999);

  pvQLabel(p,label1,0);
  pvSetGeometry(p,label1,130,10,440,30);
  pvSetText(p,label1,"VTK can only be seen, when you have compiled with VTK support.");
  ...
  pvAddWidgetOrLayout(p,layout1,label1,-1,-1);
  pvAddStretch(p,layout1,1);  
  pvAddWidgetOrLayout(p,layout2,vtk,-1,-1);
  pvAddWidgetOrLayout(p,layout2,textBrowser,-1,-1);
