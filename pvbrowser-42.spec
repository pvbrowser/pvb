...
# Requires:  tcl
# Requires:  tk
BuildRequires: libqt4-devel Mesa-devel gcc-c++ qt4-devel qt4-dev-tools python-devel liblua5.1-0.dev
%endif
...
# Requires:  tcl
# Requires:  tk
BuildRequires: libqt4-dev gcc-c++ python-devel liblua5.1-0.dev
%endif
...
cp    pvserver/libpvsmt.so.1.0.0                          %{buildroot}/opt/pvb/pvserver/
...
cp    rllib/lib/librllib.so.1.0.0                         %{buildroot}/opt/pvb/rllib/lib/
...
%__ln_s /opt/pvb/pvserver/libpvsid.so.1.0.0      %{buildroot}/usr/lib/libpvsid.so
%__ln_s /opt/pvb/pvserver/libpvsid.so.1.0.0      %{buildroot}/usr/lib/libpvsid.so.1
%__ln_s /opt/pvb/pvserver/libpvsid.so.1.0.0      %{buildroot}/usr/lib/libpvsid.so.1.0
%__ln_s /opt/pvb/pvserver/libpvsid.so.1.0.0      %{buildroot}/usr/lib/libpvsid.so.1.0.0

%__ln_s /opt/pvb/pvserver/libpvsmt.so.1.0.0      %{buildroot}/usr/lib/libpvsmt.so
%__ln_s /opt/pvb/pvserver/libpvsmt.so.1.0.0      %{buildroot}/usr/lib/libpvsmt.so.1
%__ln_s /opt/pvb/pvserver/libpvsmt.so.1.0.0      %{buildroot}/usr/lib/libpvsmt.so.1.0
...
%__ln_s /opt/pvb/rllib/lib/librllib.so.1.0.0     %{buildroot}/usr/lib/librllib.so
%__ln_s /opt/pvb/rllib/lib/librllib.so.1.0.0     %{buildroot}/usr/lib/librllib.so.1
%__ln_s /opt/pvb/rllib/lib/librllib.so.1.0.0     %{buildroot}/usr/lib/librllib.so.1.0
%__ln_s /opt/pvb/rllib/lib/librllib.so.1.0.0     %{buildroot}/usr/lib/librllib.so.1.0.0
