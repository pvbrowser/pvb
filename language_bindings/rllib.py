...
class rlSharedMemory(_object):
    ...
    def shmKey(*args): return _rllib.rlSharedMemory_shmKey(*args)
    def shmId(*args): return _rllib.rlSharedMemory_shmId(*args)
...
class rlCommandlineInterface(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _rllib.new_rlCommandlineInterface(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _rllib.delete_rlCommandlineInterface
    __del__ = lambda self : None;
    def start(*args): return _rllib.rlCommandlineInterface_start(*args)
    def readLine(*args): return _rllib.rlCommandlineInterface_readLine(*args)
    def readBlock(*args): return _rllib.rlCommandlineInterface_readBlock(*args)
    def printf(*args): return _rllib.rlCommandlineInterface_printf(*args)
    def writeBlock(*args): return _rllib.rlCommandlineInterface_writeBlock(*args)
...
class rlDataAcquisition(_object):
    ...
    def shmKey(*args): return _rllib.rlDataAcquisition_shmKey(*args)
    def shmId(*args): return _rllib.rlDataAcquisition_shmId(*args)
...
class rlPlcState(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _rllib.new_rlPlcState(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def rememberState(*args): return _rllib.rlPlcState_rememberState(*args)
    def intChanged(*args): return _rllib.rlPlcState_intChanged(*args)
    def floatChanged(*args): return _rllib.rlPlcState_floatChanged(*args)
    def doubleChanged(*args): return _rllib.rlPlcState_doubleChanged(*args)
    def intHasIncreased(*args): return _rllib.rlPlcState_intHasIncreased(*args)
    def floatHasIncreased(*args): return _rllib.rlPlcState_floatHasIncreased(*args)
    def doubleHasIncreased(*args): return _rllib.rlPlcState_doubleHasIncreased(*args)
    def intHasDecreased(*args): return _rllib.rlPlcState_intHasDecreased(*args)
    def floatHasDecreased(*args): return _rllib.rlPlcState_floatHasDecreased(*args)
    def doubleHasDecreased(*args): return _rllib.rlPlcState_doubleHasDecreased(*args)
    def deltaInt(*args): return _rllib.rlPlcState_deltaInt(*args)
    def deltaFloat(*args): return _rllib.rlPlcState_deltaFloat(*args)
    def deltaDouble(*args): return _rllib.rlPlcState_deltaDouble(*args)
    def set(*args): return _rllib.rlPlcState_set(*args)
    def clear(*args): return _rllib.rlPlcState_clear(*args)
    def isSet(*args): return _rllib.rlPlcState_isSet(*args)
    def isClear(*args): return _rllib.rlPlcState_isClear(*args)
    def hasBeenSet(*args): return _rllib.rlPlcState_hasBeenSet(*args)
    def hasBeenCleared(*args): return _rllib.rlPlcState_hasBeenCleared(*args)
    def maxInt(*args): return _rllib.rlPlcState_maxInt(*args)
    def maxFloat(*args): return _rllib.rlPlcState_maxFloat(*args)
    def maxDouble(*args): return _rllib.rlPlcState_maxDouble(*args)
...
class rlPlcMem(_object):
    ...
    def rememberState(*args): return _rllib.rlPlcMem_rememberState(*args)
    def intChanged(*args): return _rllib.rlPlcMem_intChanged(*args)
    def floatChanged(*args): return _rllib.rlPlcMem_floatChanged(*args)
    def doubleChanged(*args): return _rllib.rlPlcMem_doubleChanged(*args)
    def intHasIncreased(*args): return _rllib.rlPlcMem_intHasIncreased(*args)
    def floatHasIncreased(*args): return _rllib.rlPlcMem_floatHasIncreased(*args)
    def doubleHasIncreased(*args): return _rllib.rlPlcMem_doubleHasIncreased(*args)
    def intHasDecreased(*args): return _rllib.rlPlcMem_intHasDecreased(*args)
    def floatHasDecreased(*args): return _rllib.rlPlcMem_floatHasDecreased(*args)
    def doubleHasDecreased(*args): return _rllib.rlPlcMem_doubleHasDecreased(*args)
    def deltaInt(*args): return _rllib.rlPlcMem_deltaInt(*args)
    def deltaFloat(*args): return _rllib.rlPlcMem_deltaFloat(*args)
    def deltaDouble(*args): return _rllib.rlPlcMem_deltaDouble(*args)
    def set(*args): return _rllib.rlPlcMem_set(*args)
    def clear(*args): return _rllib.rlPlcMem_clear(*args)
    def isSet(*args): return _rllib.rlPlcMem_isSet(*args)
    def isClear(*args): return _rllib.rlPlcMem_isClear(*args)
    def hasBeenSet(*args): return _rllib.rlPlcMem_hasBeenSet(*args)
    def hasBeenCleared(*args): return _rllib.rlPlcMem_hasBeenCleared(*args)
...
class rlString(_object):
    ...
    __del__ = lambda self : None;
    def __add__(*args): return _rllib.rlString___add__(*args)
    def __iadd__(*args): return _rllib.rlString___iadd__(*args)
    def text(*args): return _rllib.rlString_text(*args)
    def setText(*args): return _rllib.rlString_setText(*args)
    def printf(*args): return _rllib.rlString_printf(*args)
    def strcpy(*args): return _rllib.rlString_strcpy(*args)
    def cat(*args): return _rllib.rlString_cat(*args)
    def upper(*args): return _rllib.rlString_upper(*args)
    def lower(*args): return _rllib.rlString_lower(*args)
    def startsWith(*args): return _rllib.rlString_startsWith(*args)
    def strnocasecmp(*args): return _rllib.rlString_strnocasecmp(*args)
    def strnnocasecmp(*args): return _rllib.rlString_strnnocasecmp(*args)
    def strstr(*args): return _rllib.rlString_strstr(*args)
    def strchr(*args): return _rllib.rlString_strchr(*args)
    def strrchr(*args): return _rllib.rlString_strrchr(*args)
    def removeQuotas(*args): return _rllib.rlString_removeQuotas(*args)
...
class rlTime(_object):
    ...
    def getIsoTimeString(*args): return _rllib.rlTime_getIsoTimeString(*args)
    ...
    def setTimeFromIsoString(*args): return _rllib.rlTime_setTimeFromIsoString(*args)
...
class rlWebcam(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _rllib.new_rlWebcam(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _rllib.delete_rlWebcam
    __del__ = lambda self : None;
    def setUrl(*args): return _rllib.rlWebcam_setUrl(*args)
    def disconnect(*args): return _rllib.rlWebcam_disconnect(*args)
    def getSnapshot(*args): return _rllib.rlWebcam_getSnapshot(*args)
    def getFrame(*args): return _rllib.rlWebcam_getFrame(*args)
    def getUrl(*args): return _rllib.rlWebcam_getUrl(*args)
    def getHost(*args): return _rllib.rlWebcam_getHost(*args)
    def getPort(*args): return _rllib.rlWebcam_getPort(*args)
    def getPath(*args): return _rllib.rlWebcam_getPath(*args)
