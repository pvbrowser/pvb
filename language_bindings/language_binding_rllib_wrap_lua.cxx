...
static int _wrap_rlThread_semaphore_set(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("semaphore",2,"WSEMAPHORE");
...
static int _wrap_new_rlCommandlineInterface(lua_State* L) {
  ...
  SWIG_check_num_args("rlCommandlineInterface",0,0)
...
static int _wrap_rlCommandlineInterface_start__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("start",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("start",1,"rlCommandlineInterface *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("start",2,"char const *");
  if(!lua_isstring(L,3)) SWIG_fail_arg("start",3,"char const *");
...
static int _wrap_rlCommandlineInterface_start__SWIG_2(lua_State* L) {
  ...
  SWIG_check_num_args("start",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("start",1,"rlCommandlineInterface *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("start",2,"rlSerial *");
...
static int _wrap_rlCommandlineInterface_start(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlCommandlineInterface_start'\n"
    "  Possible C/C++ prototypes are:\n"
    "    start(rlCommandlineInterface *,char const *,char const *)\n"
    "    start(rlCommandlineInterface *,char const *)\n"
    "    start(rlCommandlineInterface *,rlSerial *)\n");
  lua_error(L);return 0;
}
...
static int _wrap_rlCommandlineInterface_readLine__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("readLine",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("readLine",1,"rlCommandlineInterface *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("readLine",2,"int");
...
static int _wrap_rlCommandlineInterface_readLine(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlCommandlineInterface_readLine'\n"
    "  Possible C/C++ prototypes are:\n"
    "    readLine(rlCommandlineInterface *,int)\n"
    "    readLine(rlCommandlineInterface *)\n");
  lua_error(L);return 0;
}
...
static int _wrap_rlCommandlineInterface_readBlock__SWIG_0(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("readBlock",1,"rlCommandlineInterface *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("readBlock",2,"void *");
...
static int _wrap_rlCommandlineInterface_readBlock(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlCommandlineInterface_readBlock'\n"
    "  Possible C/C++ prototypes are:\n"
    "    readBlock(rlCommandlineInterface *,void *,int,int)\n"
    "    readBlock(rlCommandlineInterface *,void *,int)\n");
  lua_error(L);return 0;
}
...
static int _wrap_rlCommandlineInterface_printf(lua_State* L) {
  ...
  SWIG_check_num_args("printf",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("printf",1,"rlCommandlineInterface *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("printf",2,"char const *");
...
static int _wrap_rlCommandlineInterface_writeBlock(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("writeBlock",1,"rlCommandlineInterface *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("writeBlock",2,"void *");
...
static swig_lua_class _wrap_class_rlCommandlineInterface = { "rlCommandlineInterface", &SWIGTYPE_p_rlCommandlineInterface,_wrap_new_rlCommandlineInterface, swig_delete_rlCommandlineInterface, swig_rlCommandlineInterface_methods, swig_rlCommandlineInterface_attributes, swig_rlCommandlineInterface_bases, swig_rlCommandlineInterface_base_names };
...
static int _wrap_rlDebugPrintf(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlDebugPrintf",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlLastLinePrintf(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlLastLinePrintf",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlpass(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlpass",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlstrncpy(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlstrncpy",1,"char *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlstrncpy",2,"char const *");
...
static int _wrap_rlsnprintf(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlsnprintf",1,"char *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("rlsnprintf",2,"int");
  if(!lua_isstring(L,3)) SWIG_fail_arg("rlsnprintf",3,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (char *)lua_tostring(L, 3);
...
static int _wrap_rlFindFile(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlFindFile",1,"char const *");
...
static int _wrap_rlGetInifile(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlGetInifile",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlBrowser(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlBrowser",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlsystem(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlsystem",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlSubmitPvserver__SWIG_0(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlSubmitPvserver",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlSubmitPvserver",2,"char const *");
  if(!lua_isstring(L,3)) SWIG_fail_arg("rlSubmitPvserver",3,"char const *");
  if(!lua_isstring(L,4)) SWIG_fail_arg("rlSubmitPvserver",4,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
  arg3 = (char *)lua_tostring(L, 3);
...
static int _wrap_rlSubmitPvserver(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlSubmitPvserver'\n"
    "  Possible C/C++ prototypes are:\n"
...
static int _wrap_rlOption(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlOption",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlOption",2,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
...
static int _wrap_rlIntOption(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlIntOption",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlIntOption",2,"char const *");
...
static int _wrap_rlFloatOption(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlFloatOption",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlFloatOption",2,"char const *");
...
static int _wrap_rlTextOption(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlTextOption",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlTextOption",2,"char const *");
  if(!lua_isstring(L,3)) SWIG_fail_arg("rlTextOption",3,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
  arg3 = (char *)lua_tostring(L, 3);
...
static int _wrap_rlCopyTextfile(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlCopyTextfile",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlCopyTextfile",2,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
...
static int _wrap_rlupper(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlupper",1,"char *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rllower(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rllower",1,"char *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_rlStartsWith(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlStartsWith",1,"char const *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("rlStartsWith",2,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
...
static int _wrap_new_rlString__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("rlString",1,1)
  if(!lua_isstring(L,1)) SWIG_fail_arg("rlString",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
...
static int _wrap_new_rlString__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("rlString",0,0)
...
static int _wrap_new_rlString__SWIG_2(lua_State* L) {
  ...
  SWIG_check_num_args("rlString",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("rlString",1,"rlString &");
...
static int _wrap_new_rlString__SWIG_3(lua_State* L) {
  ...
  SWIG_check_num_args("rlString",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("rlString",1,"rlString *");
...
static int _wrap_new_rlString(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'new_rlString'\n"
    "  Possible C/C++ prototypes are:\n"
    "    rlString(char const *)\n"
    "    rlString()\n"
    "    rlString(rlString &)\n"
...
static int _wrap_rlString___add__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("operator +",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("operator +",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("operator +",2,"char const *");
...
static int _wrap_rlString___add__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("operator +",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("operator +",1,"rlString *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("operator +",2,"rlString &");
...
static int _wrap_rlString___add(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlString___add'\n"
    "  Possible C/C++ prototypes are:\n"
    "    operator +(rlString *,char const *)\n"
    "    operator +(rlString *,rlString &)\n");
  lua_error(L);return 0;
}
...
static int _wrap_rlString_text(lua_State* L) {
  ...
  SWIG_check_num_args("text",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("text",1,"rlString *");
...
static int _wrap_rlString_setText(lua_State* L) {
  ...
  SWIG_check_num_args("setText",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("setText",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("setText",2,"char const *");
...
static int _wrap_rlString_printf(lua_State* L) {
  ...
  SWIG_check_num_args("printf",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("printf",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("printf",2,"char const *");
...
static int _wrap_rlString_cat(lua_State* L) {
  ...
  SWIG_check_num_args("cat",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("cat",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("cat",2,"char const *");
...
static int _wrap_rlString_upper(lua_State* L) {
  ...
  SWIG_check_num_args("upper",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("upper",1,"rlString *");
...
static int _wrap_rlString_lower(lua_State* L) {
  ...
  SWIG_check_num_args("lower",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("lower",1,"rlString *");
...
static int _wrap_rlString_startsWith(lua_State* L) {
  ...
  SWIG_check_num_args("startsWith",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("startsWith",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("startsWith",2,"char const *");
...
static int _wrap_rlString_strnocasecmp(lua_State* L) {
  ...
  SWIG_check_num_args("strnocasecmp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("strnocasecmp",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("strnocasecmp",2,"char const *");
...
static int _wrap_rlString_strnnocasecmp(lua_State* L) {
  ...
  SWIG_check_num_args("strnnocasecmp",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("strnnocasecmp",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("strnnocasecmp",2,"char const *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("strnnocasecmp",3,"int");
...
static int _wrap_rlString_strstr(lua_State* L) {
  ...
  SWIG_check_num_args("strstr",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("strstr",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("strstr",2,"char const *");
...
static int _wrap_rlString_strchr(lua_State* L) {
  ...
  SWIG_check_num_args("strchr",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("strchr",1,"rlString *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("strchr",2,"int");
...
static int _wrap_rlString_strrchr(lua_State* L) {
  ...
  SWIG_check_num_args("strrchr",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("strrchr",1,"rlString *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("strrchr",2,"int");
...
static int _wrap_rlString_removeQuotas__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("removeQuotas",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("removeQuotas",1,"rlString *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("removeQuotas",2,"char");
...
static int _wrap_rlString_removeQuotas__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("removeQuotas",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("removeQuotas",1,"rlString *");
...
static int _wrap_rlString_removeQuotas(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlString_removeQuotas'\n"
    "  Possible C/C++ prototypes are:\n"
    "    removeQuotas(rlString *,char)\n"
    "    removeQuotas(rlString *)\n");
  lua_error(L);return 0;
}
...
static swig_lua_class _wrap_class_rlString = { "rlString", &SWIGTYPE_p_rlString,_wrap_new_rlString, swig_delete_rlString, swig_rlString_methods, swig_rlString_attributes, swig_rlString_bases, swig_rlString_base_names };
...
static int _wrap_new_rlWebcam(lua_State* L) {
  ...
  SWIG_check_num_args("rlWebcam",0,0)
...
static int _wrap_rlWebcam_setUrl(lua_State* L) {
  ...
  SWIG_check_num_args("setUrl",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("setUrl",1,"rlWebcam *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("setUrl",2,"char const *");
...
static int _wrap_rlWebcam_disconnect(lua_State* L) {
  ...
  SWIG_check_num_args("disconnect",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("disconnect",1,"rlWebcam *");
...
static int _wrap_rlWebcam_getSnapshot__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("getSnapshot",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getSnapshot",1,"rlWebcam *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("getSnapshot",2,"int");
...
static int _wrap_rlWebcam_getSnapshot__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("getSnapshot",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getSnapshot",1,"rlWebcam *");
...
static int _wrap_rlWebcam_getSnapshot(lua_State* L) {
  ...
  lua_pushstring(L,"Wrong arguments for overloaded function 'rlWebcam_getSnapshot'\n"
    "  Possible C/C++ prototypes are:\n"
    "    getSnapshot(rlWebcam *,int)\n"
    "    getSnapshot(rlWebcam *)\n");
  lua_error(L);return 0;
}
...
static int _wrap_rlWebcam_getFrame__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("getFrame",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getFrame",1,"rlWebcam *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("getFrame",2,"int");
...
static int _wrap_rlWebcam_getFrame__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("getFrame",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getFrame",1,"rlWebcam *");
...
static int _wrap_rlWebcam_getUrl(lua_State* L) {
  ...
  SWIG_check_num_args("getUrl",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getUrl",1,"rlWebcam *");
...
static int _wrap_rlWebcam_getHost(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getHost",1,"rlWebcam *");
...
static int _wrap_rlWebcam_getPort(lua_State* L) {
  ...
  SWIG_check_num_args("getPort",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getPort",1,"rlWebcam *");
...
static int _wrap_rlWebcam_getPath(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("getPath",1,"rlWebcam *");
...
static int _wrap_rlWebcam_debug_set(lua_State* L) {
  ...
  SWIG_check_num_args("debug",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("debug",1,"rlWebcam *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("debug",2,"int");
...
static int _wrap_rlWebcam_filename_set(lua_State* L) {
  ...
  SWIG_check_num_args("filename",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("filename",1,"rlWebcam *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("filename",2,"rlString *");
