...
class IntegerArray(_object):
    ...
    def __init__(self, *args): 
        this = _pv.new_IntegerArray(*args)
        try: self.this.append(this)
        except: self.this = this
...
class pvWidgetIdManager(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _pv.new_pvWidgetIdManager(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _pv.delete_pvWidgetIdManager
    __del__ = lambda self : None;
    def init(*args): return _pv.pvWidgetIdManager_init(*args)
    def newId(*args): return _pv.pvWidgetIdManager_newId(*args)
    def deleteWidget(*args): return _pv.pvWidgetIdManager_deleteWidget(*args)
    def id(*args): return _pv.pvWidgetIdManager_id(*args)
    def isInMap(*args): return _pv.pvWidgetIdManager_isInMap(*args)
    def first(*args): return _pv.pvWidgetIdManager_first(*args)
    def next(*args): return _pv.pvWidgetIdManager_next(*args)
    def end(*args): return _pv.pvWidgetIdManager_end(*args)
    def name(*args): return _pv.pvWidgetIdManager_name(*args)
...
class qtDatabase(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _pv.new_qtDatabase(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _pv.delete_qtDatabase
    __del__ = lambda self : None;
    def open(*args): return _pv.qtDatabase_open(*args)
    def close(*args): return _pv.qtDatabase_close(*args)
    def query(*args): return _pv.qtDatabase_query(*args)
    def populateTable(*args): return _pv.qtDatabase_populateTable(*args)
    def recordFieldValue(*args): return _pv.qtDatabase_recordFieldValue(*args)
    def nextRecord(*args): return _pv.qtDatabase_nextRecord(*args)
